    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Update Quantites</li>
        </ol>
      </section>
      <section class="content">
        <div class="row">
          <div class="col-md-4">
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Stocks of existing products</h3>
              </div>
              <div class="box-body">
                    ...
                    <div class="product-img">
                      ...
                      <div class="product-info">
                        <a href="javascript:void(0)" class="product-title"><?php echo ($row['Name']) ?>
                          <span class="label label-warning pull-right"><?php echo ($row['Quantity']) ?></span></a>
          ...
          <div class="col-md-4">
            <div class="box box-info" style="width:700px;height:150px;background-color:lavender">
              <div class="box-header with-border">
                <h3 class="box-title">Update Quantities of Products</h3>
              </div>
              <div class="box-body">
                    ...
                    <div class="row justify-content-center align-items-center h-100">
                      <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                          ...
                          <form action="../main/updatequantitiesmain.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="Quantity" class="form-control form-control-lg" style="width:200px;border-radius:10px;font-family:'Calibri';" placeholder="Quantity" required>
                                  </div>
                                </div>
                              </div>
                              <br>
