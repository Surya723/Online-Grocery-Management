                      ...
                      <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                          <div class="card-body p-4 p-md-5">
                            <form action="../main/addproductsmain.php" method="POST" enctype="multipart/form-data">
                              <div class="row">

                                <div class="col-md-3 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="id" class="form-control form-control-lg" style="width:200px;border-radius:10px;font-family:'Calibri';" placeholder="Product ID" required>
                                  </div>
                                </div>

                                <div class="col-md-2 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="Name" class="form-control form-control-lg" style="width:350px;border-radius:10px;font-family:'Calibri';" placeholder="Product Name" required>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="price" class="form-control form-control-lg" style="width:200px;border-radius:10px;font-family:'Calibri';" placeholder="Price" required>
                                  </div>
                                </div>

                                <div class="col-md-2 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="Sold" class="form-control form-control-lg" style="width:350px;border-radius:10px;font-family:'Calibri';" placeholder="Sold By" required>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="Rating" class="form-control form-control-lg" style="width:200px;border-radius:10px;font-family:'Calibri';" placeholder="Rating" required>
                                  </div>
                                </div>

                                <div class="col-md-2 mb-4">
                                  <div class="form-outline">
                                    <input type="text" name="quantity" class="form-control form-control-lg" style="width:350px;border-radius:10px;font-family:'Calibri';" placeholder="Quantity" required>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                <div class="col-md-2 mb-4">
                                  <div class="form-outline">
                                    <input type="file" name="Prodimg" id="Prodimg" required style="width:350px;border-radius:5px;font-family:'Calibri';"><br>
                                  </div>
                                </div>
                              </div>
                              <br>
