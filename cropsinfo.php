...
error_reporting(0);
$Crop=$_GET["search2"];
$conn=new mysqli('localhost:3307','root','','cropsinfo');
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-10">
            <div class="card p-3 py-4">
                <h5>Easier way to find information about vegetables and fruits</h5>
                <div class="row g-3 mt-2">
                    <div class="col-md-3">
                    </div>
                    <div class="col-md-6"> <input type="text" class="form-control" placeholder="Enter name"  name="search2" value="<?php if(isset($_GET['search2'])){echo $_GET['search2']; }?>" required></div>
...
<?php
    ...
    {?>
        <h5><center><?php echo "Please enter the correct name"?></center></h5>
        <br>
        <br>
    <?php
    }
